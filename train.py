...
args_parser.add_argument('-b', '--batch_size', type=int, default=16, help='Batch size used during training')
...
args_parser.add_argument('-o', '--optimizer', type=str.lower, choices=['sgd', 'momentum', 'nag', 'rmsprop', 'adam', 'nadam'], default='momentum', help='Optimization algorithm to use')
args_parser.add_argument('-lr', '--learning_rate', type=float, default=1e-2, help='Learning rate used by the optimizer')
...
args_parser.add_argument('-nhl', '--num_layers', type=int, default=3, help='Number of hidden layers in the model')
...
args_parser.add_argument('-a', '--activation', type=str.lower, choices=['identity', 'sigmoid', 'tanh', 'relu'], default='tanh', help='Activation function used in the input and hidden layers of the model')
