...
args_parser.add_argument('-b', '--batch_size', type=int, default=64, help='Batch size used during training')
...
args_parser.add_argument('-nhl', '--num_layers', type=int, default=1, help='Number of hidden layers in the model')
...
args_parser.add_argument('-a', '--activation', type=str.lower, choices=['identity', 'sigmoid', 'tanh', 'relu'], default='sigmoid', help='Activation function used in the input and hidden layers of the model')
